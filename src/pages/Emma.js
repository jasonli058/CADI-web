    ...
    <>
      <div className="grid m-0 p-30 text-center gap-8 grid-cols-12 auto-rows-[minmax(100px,auto)]">
        ...
        <div id="work" className=" border-t-2 col-start-1 col-end-13 row-span-6">
          ...
          <div>
            <div className="h-[500px] m-5 flex items-center justify-center">
              <img
                src="/img/artworks/placeholder/placeholder1.png"
                alt="oil-painting"
                className="max-w-full max-h-full rounded-xl object-contain"
              />
            </div>
            <div className="pb-5">
              <span className="block text-lg mt-5 font-bold text-center font-body"> Emma Xi </span>
        ...
        <div className='m-14'>
          ...
          >
            <ArtCard
              src="/img/artworks/emma/emma1.png"
              alt="Artwork1"
            />
            <ArtCard
            ...
            <ArtCard
              src="/img/artworks/emma/emma3.png"
              alt="Artwork3"
            />

            <ArtCard
              src="/img/artworks/emma/emma4.png"
              alt="Artwork4"
            />
          </Masonry>
        </div>
