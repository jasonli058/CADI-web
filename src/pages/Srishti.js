      ...
      <div className="grid m-0 p-30 text-center gap-8 grid-cols-12 auto-rows-[minmax(100px,auto)]">
        ...
        <div id="work" className=" border-t-2 col-start-1 col-end-13 row-span-6">
          ...
          <div>
            ...
            <div className="pb-5">
              <span className="block text-lg mt-5 font-bold text-center font-body"> Srishti </span>
              <span className='block text-lg mt-3 text-center font-body text-primary'> Handicrafts </span>
            </div>
          </div>
        </div>
        ...
        <div className='m-14'>
          ...
          >
            <ArtCard
              src="/img/artworks/sris/sris1.png"
              alt="Artwork1"
            />
            <ArtCard
              src="/img/artworks/sris/sris2.png"
              alt="Artwork2"
            />
            
            <ArtCard
              src="/img/artworks/sris/sris3.png"
              alt="Artwork3"
            />
          </Masonry>
        </div>
